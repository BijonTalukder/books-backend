...
const initializeSslPayment = async (orderData: any, res: Response, next: NextFunction) => {
    ...
    const paymentData = {
        ...
        tran_id,
          ...
          fail_url: `http://localhost:4000/api/v1/fail?transactionId=${tran_id}`,
          cancel_url: `http://localhost:4000/api/v1/cancel?transactionId=${tran_id}`,
          ipn_url: `http://localhost:4000/api/v1/cancel?transactionId=${tran_id}`,
